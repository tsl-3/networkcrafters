...
import { UserPlus, Lightbulb, MessageSquare, Search, FileText, Users, Workflow, Bot } from "lucide-react";
...
export function AiTabNavigation({ activeTab }: AiTabNavigationProps) {
  return (
    <TabsList className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2 bg-gray-800/50 p-1">
      <TabsTrigger 
